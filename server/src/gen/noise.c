...
double arpt_fbm2(double x, double y, int octaves, double lacunarity,
                 double persistence) {
    double sum = 0.0;
...
double arpt_fbm3(double x, double y, double z, int octaves, double lacunarity,
                 double persistence) {
    double sum = 0.0;
    double amplitude = 1.0;
    double frequency = 1.0;
    ...
    for (int i = 0; i < octaves; i++) {
        sum += amplitude *
               arpt_simplex3(x * frequency, y * frequency, z * frequency);
        max_amp += amplitude;
        frequency *= lacunarity;
        amplitude *= persistence;
    }
