...
void hashmap_set_allocator(void *(*_malloc)(size_t), void (*_free)(void*)) {
    __malloc = _malloc;
    __free = _free;
}
...
/* MurmurHash3_86_128 (Austin Appleby — public domain) */
...
/* xxHash3 (Yann Collet — BSD 2-Clause) */
...
static uint64_t xxh3(const void* data, size_t len, uint64_t seed) {
    ...
    if (len >= 32) {
        ...
        do {
            ...
            v2 = XXH_rotl64(v2, 31); v2 *= XXH_PRIME_1;
            v3 += XXH_read64(p + 16) * XXH_PRIME_2;
            v3 = XXH_rotl64(v3, 31); v3 *= XXH_PRIME_1;
            v4 += XXH_read64(p + 24) * XXH_PRIME_2;
            v4 = XXH_rotl64(v4, 31); v4 *= XXH_PRIME_1;
            p += 32;
        } while (p <= limit);
        h64 = XXH_rotl64(v1, 1) + XXH_rotl64(v2, 7) + XXH_rotl64(v3, 12) +
            XXH_rotl64(v4, 18);
        v1 *= XXH_PRIME_2; v1 = XXH_rotl64(v1, 31); v1 *= XXH_PRIME_1;
        h64 ^= v1; h64 = h64 * XXH_PRIME_1 + XXH_PRIME_4;
        v2 *= XXH_PRIME_2; v2 = XXH_rotl64(v2, 31); v2 *= XXH_PRIME_1;
        h64 ^= v2; h64 = h64 * XXH_PRIME_1 + XXH_PRIME_4;
        v3 *= XXH_PRIME_2; v3 = XXH_rotl64(v3, 31); v3 *= XXH_PRIME_1;
        h64 ^= v3; h64 = h64 * XXH_PRIME_1 + XXH_PRIME_4;
        v4 *= XXH_PRIME_2; v4 = XXH_rotl64(v4, 31); v4 *= XXH_PRIME_1;
        h64 ^= v4; h64 = h64 * XXH_PRIME_1 + XXH_PRIME_4;
    } else {
    ...
    while (p + 8 <= end) {
        ...
        k1 *= XXH_PRIME_2; k1 = XXH_rotl64(k1, 31); k1 *= XXH_PRIME_1;
        h64 ^= k1;
